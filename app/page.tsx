...
const picks = [
  ...
  { rank: "02", title: "Late Fame", note: "Kent Jones · 2025 · USA", when: "Sat Aug 8 · 6:00 PM", venue: "Film at Lincoln Center", tags: ["Q&A", "SCORSESE MODERATES"], href: "https://www.filmlinc.org/films/late-fame/", image:images.lateFame, reason: "Kent Jones, Willem Dafoe and Edmund Donovan appear after the film, with Martin Scorsese moderating. That guest combination makes this one of the rarest live film-culture events of the month." },
  { rank: "03", title: "Millennium Mambo", note: "Hou Hsiao-hsien · 2001 · Taiwan", when: "Sat Aug 8 · 10:45 PM", venue: "Metrograph", tags: ["SPECIAL FOCUS", "ONE-OFF"], href: links.mambo, image:images.mambo, reason: "Hou's neon-lit turn-of-the-century Taipei reverie is a direct Special Focus hit. One late-night screening this week, and its nocturnal pulse is unusually well matched to the slot." },
  { rank: "04", title: "Center Stage", note: "Stanley Kwan · 1991 · Hong Kong", when: "Sat Aug 8 · 6:30 PM", venue: "Film Forum", tags: ["ASIAN CINEMA", "DIRECTOR IN PERSON"], href: "https://filmforum.org/film/center-stage", image:images.centerStage, reason: "A major Hong Kong classic with Stanley Kwan in person for a post-film conversation. It unfortunately conflicts with the 6:00 PM Late Fame + Scorsese event." },
  ...
  { rank: "06", title: "The Traveler", note: "Abbas Kiarostami · 1974 · Iran", when: "Thu Aug 13 · 6:10 PM", venue: "Metrograph", tags: ["SPECIAL FOCUS", "WEST ASIA"], href: links.traveler, image:images.traveler, reason: "Kiarostami's first feature: a funny, unsentimental childhood quest movie whose football obsession gives his later moral puzzles an early shape." },
  { rank: "07", title: "Good Morning", note: "Yasujirō Ozu · 1959 · Japan", when: "Sat Aug 8 · 11:45 AM", venue: "Metrograph", tags: ["ASIAN CANON", "35MM"], href: "https://metrograph.com/film/?vista_film_id=9999004946", image:images.goodMorning, reason: "Ozu's deceptively light suburban comedy is canonical and wonderful in color; the 35mm presentation is exactly the sort of repertory opportunity worth protecting." },
  { rank: "08", title: "Irréversible", note: "Gaspar Noé · 2002 · France", when: "Fri Aug 14 · 11:00 PM", venue: "Metrograph", tags: ["35MM", "CULT CANON"], href: "https://metrograph.com/film/?vista_film_id=9999004959", image:images.irreversible, reason: "Noé's reverse-chronology assault on narrative time remains enormously influential and deeply confrontational. A late-Friday 35mm screening is exactly the right repertory context for it." },
];
  ...
  return (
    <main>
      ...
      <section className="hero" id="top">
        <div className="hero-rotator" aria-hidden="true"><span style={{backgroundImage:`url("${images.hole}")`}}/><span style={{backgroundImage:`url("${images.lateFame}")`}}/><span style={{backgroundImage:`url("${images.mambo}")`}}/></div>
      ...
      <section className="three" aria-labelledby="only-three">
        ...
        <ol>
          ...
          <li><b>LATE FAME</b><span>Jones + Dafoe + Donovan · Scorsese moderates</span></li>
          <li><b>MILLENNIUM MAMBO</b><span>Hou · Special Focus</span></li>
        </ol>
      </section>
      ...
      <section className="section" id="picks">
        <div className="section-head"><p className="kicker">01 / 🎬 THIS WEEK</p><h2>Top picks</h2><p>Eight screenings I would build the Aug 8–14 week around—expanded where the week genuinely earns it.</p></div>
      ...
      <section className="alert"><span>⚡ SATURDAY CONFLICT</span><p><b>Late Fame</b> at 6:00 PM (Jones, Dafoe and Donovan; Martin Scorsese moderates) directly conflicts with <b>Center Stage</b> at 6:30 PM with Stanley Kwan in person. I would take the rarer Scorsese-moderated conversation, then catch Kwan’s film another time if possible.</p></section>

      <section className="section dark" id="special">
        <div className="section-head"><p className="kicker">02 / 🎯 SPECIAL FOCUS</p><h2>Four hits this week</h2><p>Hou, Tsai, Tarkovsky and Kiarostami make this a particularly strong seven-day window.</p></div>
      ...
      <section className="section" id="new">
        ...
        <div className="mini-grid">
          ...
          <article className="image-card compact-image" style={cardBg(images.lateFame)}><Tag>NEW RELEASE</Tag><h3>Late Fame</h3><p><b>Kent Jones · Film at Lincoln Center · Aug 8–11</b></p><p>Willem Dafoe plays a forgotten poet unexpectedly rediscovered by younger admirers. The Aug 8 3:15 and 6:00 PM shows add Jones, Dafoe and Edmund Donovan Q&As; Martin Scorsese moderates the 6:00 conversation.</p><a href="https://www.filmlinc.org/films/late-fame/" target="_blank" rel="noreferrer">Film at Lincoln Center ↗</a></article>
        </div>
      </section>
      ...
      <section className="section soon" id="soon">
        <div className="section-head"><p className="kicker">09 / 🔭 COMING SOON — SPECIAL FOCUS</p><h2>Your next 30 days</h2><p>Only direct Special Focus matches announced for Aug 15–Sep 7: BAM’s concentrated Tarkovsky/Apichatpong run, a five-hour Hamaguchi, then Lynch and Tsai at Metrograph.</p></div>
        <div className="soon-grid">
          ...
          <article className="image-card soon-image" style={cardBg(images.happyHour)}><span>AUG 22 · 2:10 PM · METROGRAPH</span><h3>Happy Hour / ハッピーアワー</h3><p><b>Ryūsuke Hamaguchi · 2015 · 317 min · DCP</b></p><p>Hamaguchi’s five-hour ensemble breakthrough is a serious time commitment, but this is exactly the sort of Special Focus repertory return that can disappear from NYC calendars for long stretches.</p><a className="official-link" href="https://metrograph.com/film/?vista_film_id=9999001933" target="_blank" rel="noreferrer">Official listing ↗</a></article>
          <article className="image-card soon-image" style={cardBg(images.mulholland)}><span>AUG 29 · 10:30 PM / AUG 30 · 4:00 PM · METROGRAPH</span><h3>Mulholland Drive</h3><p><b>David Lynch · 2001 · 147 min · 35mm</b></p><p>A direct Special Focus bullseye, and 35mm makes this more than a routine Lynch revival. The Saturday late show has the nocturnal texture the film deserves; Sunday is the easier practical option.</p><a className="official-link" href="https://metrograph.com/film/?vista_film_id=9999002169" target="_blank" rel="noreferrer">Official listing ↗</a></article>
          <article className="image-card soon-image" style={cardBg(images.goodbyeDragon)}><span>AUG 30 · 11:15 AM · METROGRAPH</span><h3>Goodbye, Dragon Inn / 不散</h3><p><b>Tsai Ming-liang · 2003 · 82 min · DCP</b></p><p>A movie about the final screening in a dying movie palace, watched inside another movie theater: perhaps the most perversely appropriate way to revisit Tsai’s great elegy for theatrical spectatorship.</p><a className="official-link" href="https://metrograph.com/film/?vista_film_id=9999000006" target="_blank" rel="noreferrer">Official listing ↗</a></article>
        </div>
      </section>

      <section className="section events" id="events">
        <div className="section-head"><p className="kicker">10 / 🎤 NYC FILM EVENTS</p><h2>Next 30 days</h2><p>A broad rolling radar of screenings with people in the room: Q&amp;As, introductions, conversations and restoration presentations from Aug 8–Sep 7. Ticket status reflects the official page at this check; always recheck before traveling.</p></div>
        <div className="event-list">
          <div><time>AUG 08 · 3:15 & 6:00 PM</time><h3><a href="https://www.filmlinc.org/films/late-fame/" target="_blank" rel="noreferrer">Late Fame — Kent Jones, Willem Dafoe & Edmund Donovan</a></h3><p>Film at Lincoln Center · Q&A after both shows; <b>Martin Scorsese moderates the 6:00 PM conversation</b>. Official listing does not label either Q&A sold out at this check.</p><b>TOP EVENT</b></div>
          <div><time>AUG 08 · 6:30 PM</time><h3><a href="https://filmforum.org/film/center-stage" target="_blank" rel="noreferrer">Center Stage — Stanley Kwan in person</a></h3><p>Film Forum · post-film conversation with director <b>Stanley Kwan</b>. Tickets are offered on Film Forum’s official listing; conflicts directly with Late Fame at 6:00.</p></div>
          <div><time>AUG 08 · 6:35 PM</time><h3><a href="https://www.ifccenter.com/films/julian/" target="_blank" rel="noreferrer">Julian — Cato Kusters Q&A</a></h3><p>IFC Center · director <b>Cato Kusters</b> after the 6:35 PM screening. Official listing does not mark this show sold out at this check.</p></div>
          <div><time>AUG 08 · 7:35 PM</time><h3><a href="https://www.ifccenter.com/films/the-big-cheese/" target="_blank" rel="noreferrer">The Big Cheese — Sara Joe Wolansky & Adam Moskowitz</a></h3><p>IFC Center · director <b>Sara Joe Wolansky</b> and subject <b>Adam Moskowitz</b>; <b>moderated by Josh Windsor</b>. Official listing does not mark this show sold out at this check.</p></div>
          ...
          <div><time>AUG 11 · 7:00 PM</time><h3><a href="https://www.roxycinemanewyork.com/events/qa-with-brad-anderson-and-stephen-gevedon/" target="_blank" rel="noreferrer">Session 9 — 25th anniversary Q&A</a></h3><p>Roxy Cinema · director/co-writer <b>Brad Anderson</b> and lead actor/co-writer <b>Stephen Gevedon</b>; <b>moderated by Adam Elliott</b>. Roxy currently offers $19 tickets.</p></div>
          <div><time>AUG 12 · 6:30 PM</time><h3><a href="https://www.moma.org/calendar/events/11597" target="_blank" rel="noreferrer">FAST — world premiere conversation</a></h3><p>MoMA · followed by a conversation with <b>Rob Tregenza and Madison Pankey</b>. MoMA’s official page currently offers ticket reservations.</p></div>
          <div><time>AUG 12 · 6:30 PM</time><h3><a href="https://metrograph.com/film/?vista_film_id=9999004980" target="_blank" rel="noreferrer">Girl with a Suitcase — James Gray</a></h3><p>Metrograph · Members Only · post-screening conversation with <b>James Gray</b>, <b>moderated by David Ehrlich</b>. General admission for members.</p></div>
          <div><time>AUG 12 · 7:00 PM</time><h3><a href="https://www.filmlinc.org/films/buddy/" target="_blank" rel="noreferrer">Buddy — Casper Kelly Q&A</a></h3><p>Film at Lincoln Center · Scary Movies XIV opening night · director <b>Casper Kelly</b> in person. <b>Single tickets sold out</b>; FLC says limited All-Access Passes remain.</p></div>
          <div><time>AUG 13 · 6:30 PM</time><h3><a href="https://www.filmlinc.org/films/the-peril-at-pincer-point/" target="_blank" rel="noreferrer">The Peril at Pincer Point — directors Q&A</a></h3><p>Film at Lincoln Center · New York premiere · <b>Noah Stratton-Twine and Jake Kuhn</b> in person. Not marked sold out at this check.</p></div>
          ...
          <div><time>AUG 14 · 6:45 PM</time><h3><a href="https://www.filmlinc.org/films/goody-goody/" target="_blank" rel="noreferrer">Goody Goody — Raymond Creamer Q&A</a></h3><p>Film at Lincoln Center · New York premiere · director <b>Raymond Creamer</b> in person. Not marked sold out at this check.</p></div>
          <div><time>AUG 14 · 7:15 & 9:50 PM</time><h3><a href="https://www.ifccenter.com/films/mysterious-skin/" target="_blank" rel="noreferrer">Mysterious Skin 4K — Gregg Araki & Scott Heim</a></h3><p>IFC Center · 7:15 PM Q&A with <b>Gregg Araki and novelist Scott Heim</b> is <b>sold out</b>. The 9:50 PM show has an extended Araki introduction and was still offering tickets.</p><b>⚠️ TARGET 9:50 PM</b></div>
          ...
          <div><time>AUG 16 · 3:45 PM</time><h3><a href="https://www.filmlinc.org/films/the-trek/" target="_blank" rel="noreferrer">The Trek — Meekaaeel Adam Q&A</a></h3><p>Film at Lincoln Center · North American premiere · director <b>Meekaaeel Adam</b> in person. Not marked sold out at this check.</p></div>
          <div><time>AUG 16 · 6:30 PM</time><h3><a href="https://www.filmlinc.org/films/henry-portrait-serial-killer/" target="_blank" rel="noreferrer">Henry: Portrait of a Serial Killer — 4K restoration + John McNaughton</a></h3><p>Film at Lincoln Center · world premiere of the new 4K restoration · Q&A with <b>John McNaughton</b>. Not marked sold out at this check.</p></div>
          <div><time>AUG 18 · 9:15 PM</time><h3><a href="https://www.filmlinc.org/films/bodyhackers/" target="_blank" rel="noreferrer">Bodyhackers — Carlos Conceição & McCaul Lombardi</a></h3><p>Film at Lincoln Center · North American premiere · Q&A with <b>Carlos Conceição and McCaul Lombardi</b>. Not marked sold out at this check.</p></div>
          <div><time>AUG 19 · 6:30 PM</time><h3><a href="https://www.filmlinc.org/films/family-movie/" target="_blank" rel="noreferrer">Family Movie — Kevin Bacon, Kyra Sedgwick & Travis Bacon</a></h3><p>Film at Lincoln Center · Q&A with <b>Kevin Bacon, Kyra Sedgwick and Travis Bacon</b>. Not marked sold out on the official listing at this check.</p></div>
          <div><time>AUG 20 · 6:30 PM</time><h3><a href="https://www.filmlinc.org/films/the-threshing/" target="_blank" rel="noreferrer">The Threshing — closing-night Q&A</a></h3><p>Film at Lincoln Center · <b>Sean Mannion and Simone Grossman</b> in person. Film-only tickets and screening + closing-party tickets are offered on the official page.</p></div>
          ...
          <div><time>AUG 21 · 7:00 PM / AUG 22 · 9:30 PM</time><h3><a href="https://www.roxycinemanewyork.com/events/qa-with-sabrina-greco-and-blu-hunt-2/" target="_blank" rel="noreferrer">Lockjaw — Sabrina Greco & Blu Hunt</a></h3><p>Roxy Cinema · Q&A with <b>director Sabrina Greco and lead actor Blu Hunt</b> after both screenings; <b>Megan Bitchell moderates Aug 22</b>. Roxy currently offers $19 tickets.</p></div>
          <div><time>AUG 22 · 12:15 PM</time><h3><a href="https://metrograph.com/film/?vista_film_id=9999004979" target="_blank" rel="noreferrer">Saturday Afternoon Cartoons: Bugs We Love(?) — Tommy J. Stathes</a></h3><p>Metrograph · 16mm program · introduction and Q&A with archivist/programmer <b>Tommy J. Stathes</b>.</p></div>
          <div><time>AUG 25 · 7:00 PM</time><h3><a href="https://www.roxycinemanewyork.com/events/qa-with-william-wrubel/" target="_blank" rel="noreferrer">When We Saw Each Other More Often — William Wrubel Q&A</a></h3><p>Roxy Cinema · writer/director <b>William Wrubel</b> after the screening. Roxy currently offers $19 tickets.</p></div>
          <div><time>AUG 28 · 7:30 PM / AUG 29 · 8:00 PM</time><h3><a href="https://www.anthologyfilmarchives.org/film_screenings/series/61608" target="_blank" rel="noreferrer">Tony Ganz + Rhody Streeter — filmmakers in person</a></h3><p>Anthology Film Archives · New Discoveries program · <b>Tony Ganz and Rhody Streeter</b> in person for Q&As after both screenings; restored 16mm work included.</p></div>
          <div><time>AUG 31 · 6:00 PM</time><h3><a href="https://www.filmlinc.org/films/the-kill-off-my-new-gun/" target="_blank" rel="noreferrer">Missing Movies — 35mm double feature + panel</a></h3><p>Film at Lincoln Center · <i>The Kill-Off</i> at 6:00, panel, then <i>My New Gun</i> at 9:00 · panel with <b>Maggie Greenwald, Stacy Cochran and additional Missing Movies members</b>. Tickets include both films and the panel.</p></div>
        </div>
      </section>
