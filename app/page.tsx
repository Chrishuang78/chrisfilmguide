    ...
    <main>
      ...
      <section className="section schedule" id="all">
        ...
        <div className="schedule-grid">
          <div><h3>SAT 08</h3><p>Metrograph — Good Morning <TimeLink href={links.metrograph}>11:45</TimeLink>; Le amiche <TimeLink href={links.metrograph}>11:50</TimeLink>; The Warriors <TimeLink href={links.metrograph}>1:50</TimeLink>; Chocolat <TimeLink href={links.metrograph}>2:00</TimeLink>; The Chaser <TimeLink href={links.metrograph}>3:50</TimeLink>; Otar Iosseliani Early Shorts <TimeLink href={links.metrograph}>4:15</TimeLink>; First Blood <TimeLink href={links.metrograph}>6:25</TimeLink>; Night Is Short, Walk on Girl <TimeLink href={links.metrograph}>6:30</TimeLink>; Girlhood <TimeLink href={links.metrograph}>8:25</TimeLink>; Dumplings <TimeLink href={links.metrograph}>8:45</TimeLink>; Millennium Mambo <TimeLink href={links.mambo}>10:45</TimeLink>; In the Mood for Love <TimeLink href="https://metrograph.com/film/?vista_film_id=9999000517">10:50</TimeLink>.</p></div>
          <div><h3>SUN 09</h3><p>Metrograph — Vertigo <TimeLink href={links.metrograph}>11:00</TimeLink>; Girlhood <TimeLink href={links.metrograph}>11:15</TimeLink>; Le amiche <TimeLink href={links.metrograph}>1:30</TimeLink>; The Hole <TimeLink href={links.hole}>1:40</TimeLink>; The Kid <TimeLink href={links.metrograph}>3:40</TimeLink>; Rebecca <TimeLink href={links.metrograph}>4:10</TimeLink>; Favorites of the Moon <TimeLink href={links.metrograph}>5:00</TimeLink>; Conversation Piece <TimeLink href={links.metrograph}>6:45</TimeLink>; And Then There Was Light <TimeLink href={links.metrograph}>7:15</TimeLink>; The Chaser <TimeLink href={links.metrograph}>9:15</TimeLink>; Scene of the Crime <TimeLink href={links.metrograph}>9:30</TimeLink>. MoMI — Amadeus 70mm <TimeLink href="https://movingimage.org/event/amadeus-70mm/2026-08-09/">3:00</TimeLink>.</p></div>
          <div><h3>MON 10</h3><p>Metrograph — Bouchra <TimeLink href={links.metrograph}>3:10</TimeLink>; Toute une nuit <TimeLink href={links.metrograph}>3:15</TimeLink>; La Collectionneuse <TimeLink href={links.metrograph}>5:00</TimeLink>; Millionaires’ Express <TimeLink href={links.metrograph}>5:15</TimeLink>; 3 Women <TimeLink href={links.metrograph}>7:00</TimeLink>; The Razor’s Edge + Lebanese, Hostage of Their City <TimeLink href={links.metrograph}>7:20</TimeLink>; Collateral <TimeLink href={links.metrograph}>9:35</TimeLink>; Tampopo <TimeLink href="https://metrograph.com/film/?vista_film_id=9999002885">9:40</TimeLink>.</p></div>
          <div><h3>TUE 11</h3><p>Metrograph — Vertigo <TimeLink href={links.metrograph}>3:15</TimeLink>; The Great Silence <TimeLink href={links.metrograph}>3:45</TimeLink>; Before Sunrise <TimeLink href={links.metrograph}>5:50</TimeLink>; The Green Room <TimeLink href={links.metrograph}>6:00</TimeLink>; Love in the Afternoon <TimeLink href={links.metrograph}>8:00</TimeLink>; The Red Light Bandit <TimeLink href={links.metrograph}>8:00</TimeLink>; Good Time <TimeLink href={links.metrograph}>10:00</TimeLink>; Fallen Angels <TimeLink href={links.metrograph}>10:10</TimeLink>. Anthology — Time to Die <TimeLink href="https://www.anthologyfilmarchives.org/film_screenings/series/61653">6:45</TimeLink>; The Shooting <TimeLink href="https://www.anthologyfilmarchives.org/film_screenings/series/61653">9:00</TimeLink>.</p></div>
          <div><h3>WED 12</h3><p>Metrograph — Solaris <TimeLink href={links.solaris}>3:15</TimeLink>; Mountains of the Moon <TimeLink href={links.metrograph}>4:30</TimeLink>; Girl with a Suitcase with James Gray <TimeLink href={links.metrograph}>6:30</TimeLink> (members); Take Care of My Cat <TimeLink href={links.metrograph}>7:20</TimeLink>; State of Grace <TimeLink href={links.metrograph}>9:35</TimeLink>; El Topo <TimeLink href={links.metrograph}>9:40</TimeLink>. Anthology — Nobody Wanted to Die <TimeLink href="https://www.anthologyfilmarchives.org/film_screenings/series/61653">6:30</TimeLink>; The Belle Starr Story <TimeLink href="https://www.anthologyfilmarchives.org/film_screenings/series/61653">9:00</TimeLink>.</p></div>
          <div><h3>THU 13</h3><p>Metrograph — La Haine <TimeLink href={links.metrograph}>2:00</TimeLink>; Happy Together <TimeLink href={links.metrograph}>2:10</TimeLink>; Linda Linda Linda <TimeLink href={links.metrograph}>4:00</TimeLink>; L’Argent <TimeLink href={links.metrograph}>4:15</TimeLink>; The Traveler <TimeLink href={links.traveler}>6:10</TimeLink>; Do You Love Me <TimeLink href={links.metrograph}>6:20</TimeLink>; JFK <TimeLink href={links.metrograph}>7:45</TimeLink>. IFC — Union County <TimeLink href="https://www.ifccenter.com/films/union-county/">7:00 Q&A</TimeLink> (sold out at last check). Anthology — Cuban Film Festival opens; Little Peach <TimeLink href="https://www.anthologyfilmarchives.org/film_screenings/series/61673">7:00</TimeLink>.</p></div>
          <div><h3>FRI 14</h3><p>Metrograph — Les Bonnes Femmes <TimeLink href={links.metrograph}>1:45</TimeLink>; The Warriors <TimeLink href={links.metrograph}>2:00</TimeLink>; La Notte <TimeLink href={links.metrograph}>3:50</TimeLink>; Deliverance <TimeLink href={links.metrograph}>4:10</TimeLink>; Nil by Mouth <TimeLink href={links.metrograph}>6:20</TimeLink>; Walkabout <TimeLink href={links.metrograph}>6:30</TimeLink>; The Hunger <TimeLink href={links.metrograph}>8:45</TimeLink>; Obsession <TimeLink href={links.metrograph}>8:50</TimeLink>; Chungking Express <TimeLink href={links.metrograph}>10:50</TimeLink>; Irréversible <TimeLink href={links.metrograph}>11:00</TimeLink>. MoMI — The Untouchables 70mm <TimeLink href="https://movingimage.org/event/the-untouchables-3/2026-08-14/">6:30</TimeLink>. Anthology — Black God, White Devil <TimeLink href="https://www.anthologyfilmarchives.org/film_screenings/series/61653">6:30</TimeLink>.</p></div>
        </div>
      </section>
